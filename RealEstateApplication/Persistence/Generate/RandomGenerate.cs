...
namespace Persistence.Generate
{
    public static class RandomGenerate
    {
        ...
        private static Product GenerateRandomProduct(int id)
        {
            ...
            {
                Id = Guid.NewGuid(),
                productName = GetRandomTitle(),
                productDescription = GetRandomDescription(),
                productTotalSquareFootage = random.Next(80, 300),
                productPrice = random.Next(10000, 150000),
                productPropertyTypeId = (short)random.Next(1, 4),
                productFurnitureConditionId = (short)random.Next(4, 6),
                productNumberOfRoomsId = (short)random.Next(6, 12),
                productFloorLevelId = (short)random.Next(12, 19),
                productBuildingAgeId = (short)random.Next(19, 29),
                ProductImageUrl = GetProductPhotoUrl()
            };
